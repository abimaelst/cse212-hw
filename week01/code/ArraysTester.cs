public static class ArraysTester
{
    ...
    private static double[] MultiplesOf(double number, int length)
    {
        ...
        // 2. Initialize the first element to 'number'.
        // 3. Iterate through the array from the second element to the end.
        // 4. For each element, calculate the multiple by multiplying the 'number' by the index.
        // 5. Return the array.
    ...
    private static void RotateListRight(List<int> data, int amount)
    {
        ...
        // 1. Handle the case where the amount is a multiple of the list's size (no rotation needed).
        // 2. Adjust the amount to be within the valid range (1 to data.Count - 1).
        // 3. Take the sublist from the end of size 'amount' and store it temporarily.
        // 4. Remove these elements from the end of the original list.
        // 5. Insert the temporarily stored sublist at the beginning of the original list.
        ...
        amount %= data.Count; // Ensure amount is within the valid range
